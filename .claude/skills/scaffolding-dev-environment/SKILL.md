...
pnpm; Terraform: fmt/validate/tflint/tfsec; plus Dependabot + pinact + mise). It is
...
| **Terraform** | fmt -check + validate + tflint + tfsec | [references/terraform.md](references/terraform.md) |
